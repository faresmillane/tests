  ...
  /*clicks*/
  Given(/^I click on the "(.*)"."(.*)" button$/, async function (action, page, element) {});
  /*data*/
  ...
  /*utils*/
  Given(/^I log in as "(.*)"."(.*)" user$/, async function (NaN, userType) {});
  Given(/^I select "(.*)" entreprise in the "(.*)"."(.*)" list$/, async function (expectedText, page, element) {});